...
import 'package:presensiapps/pages/widgets/rekamwajah-form.dart';
...
class RekamWajah extends StatefulWidget {
  ...
  @override
  RekamWajahState createState() => RekamWajahState();
}

class RekamWajahState extends State<RekamWajah> {
  ...
  Future<void> takePicture() async {
    if (_faceDetectorService.faceDetected) {
      ...
      showDialog(
          context: context,
          builder: (context) =>
              AlertDialog(content: Text('No face terdetected!')));
    }
  }
  ...
  Future<void> onTap() async {
    ...
    if (_faceDetectorService.faceDetected) {
      ...
      var bottomSheetController = scaffoldKey.currentState!
          .showBottomSheet((context) => rekamWajahSheet(user: user));
  ...
  rekamWajahSheet({@required User? user}) => user == null
      ? Container(
      ...
      : RekamWajahSheet(user: user, userid: userid!);
}
